...
class CoverageSpecialist():
    ...
    def determine_claim(self, user_id: str, claim: str) -> Tuple[str, ClaimResult]:
        ...
        if policy_id is None:
            ...
            matched_exclusion_rules = {
                rule: self._match_exclusion_rule(claim, rule)
        ...
        reply = self._reply_to_claim(claim, decision)
